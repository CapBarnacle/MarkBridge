...
| [33-bmt-document-ir-audit.md](/home/intak.kim/project/MarkBridge/docs/33-bmt-document-ir-audit.md) | BMT 샘플 기준 실제 DocumentIR audit snapshot |
...
| DocumentIR 1차 보강 구현 | `done` | `parser_block_ref`, `heading_level`, `BlockIR.source` 확대, table `header_depth`/title/caption 보강 반영 |
...
- 구현된 P1 IR 보강 범위를 실제 sample audit 결과로 검증
...
- BMT 샘플 audit snapshot은 [33-bmt-document-ir-audit.md](/home/intak.kim/project/MarkBridge/docs/33-bmt-document-ir-audit.md)에 기록
